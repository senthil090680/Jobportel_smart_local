...
//echo $javascript->link(array('common','validation'));
//echo $validation->bind('Employee',array('formId'=>'eeregister','inline' => true,'messageId' => 'message')); 
//pr($Employ);
//exit(0);
?>
<tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">     
      ...
      <tr>
        ...
        <td width="50%" align="left" valign="top"><div class="dbgg">
          <?php echo $form->create('Employee',array('url'=>array('controller'=>'users', 'action'=>'register'),'id'=>'frm_employee','onSubmit'=>'return employee_vali()','name'=>'frm_employee')); ?>
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="4%" align="left" valign="middle">&nbsp;</td>
              <td colspan="2" align="left" valign="middle" class="txt"><strong>
			  <?php 			 		  
			  if($confirmed) { echo 'Congratulations! You have successfully confirmed your account. Now you can login'; }  
			  else if($confirmed == 0) {
					echo 'Invalid Confirmation. Please sign up.';
			  }
			  else if($session->flash()) { echo $session->flash(); } else {?>			  
            ...
            <tr>
			  ...
			  echo $form->input('firstname',array('label'=>false,'size'=>'35','id'=>'firstname','class'=>'inputs'));
			  //echo $form->input('firstname', array('size' => '35','label'=>false,'id' => 'firstname', 'onclick'=> 'test("'.$Employ.'");' , 'value'=>'', 'class'=> 'inputs' )); //Working function for javascript onclick with php parameters
			  ?><!-- <input type="text" name="textfield" size="35" class="inputs" /> -->
			  <div id='message'></div>
			  </td>
            </tr>
            <tr>
            ...
            <tr>
			  ...
			  <?php echo $form->input('lastname',array('label'=>false,'size'=>'35','id'=>'lastname','class'=>'inputs')); ?>
            ...
            <tr>
              ...
              <td align="left" valign="middle">
			  <?php echo $form->input('email',array('label'=>false,'size'=>'35','id'=>'email','class'=>'inputs')); ?>
			  <!-- <input type="text" name="textfield22" size="35" class="inputs" /> --></td>
            </tr>
            <tr>
              <td align="left" valign="middle">&nbsp;</td>
              <td align="left" valign="middle" class="txt">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="left" valign="middle">
			  <?php echo $form->input('password',array('label'=>false,'type'=>'password','size'=>'35','id'=>'password','class'=>'inputs')); ?>
            ...
            <tr>
              ...
              <td align="left" valign="middle">
			  <?php echo $form->input('city',array('label'=>false,'size'=>'35','id'=>'city','class'=>'inputs')); ?>
            ...
            <tr>
              <td align="left" valign="middle">&nbsp;</td>
              <td align="left" valign="middle" class="txt">Phone No : </td>
              <td align="left" valign="middle">
			  <?php echo $form->input('telephone',array('label'=>false,'size'=>'35','id'=>'telephone','class'=>'inputs')); ?>
