...
insert  into `employees`(`id`,`firstname`,`lastname`,`email`,`usertype`,`password`,`city`,`telephone`,`confirmed`,`confirm_code`) values (37,'Senthil','kumar','sen',1,'716dedbea148381325b82206c2c11aaf1dfd8be7','Chennai','044-48250000','1','51406ecd-3530-4af6-bc10-035ccd6442f8'),(38,'senthil','kumar','sen',2,'0a10a416d619ec78f7c84b12f8458151705f2714','Chennai','044-26585000','1','51419e87-409c-4bc1-b904-096ccd6442f8'),(39,'Senthil','kumar','senthilsang24@gmail.com',NULL,'716dedbea148381325b82206c2c11aaf1dfd8be7','Chennai','044-58898989','1','514d66bc-4ce0-4dda-bb53-0908cd6442f8'),(40,'Rajesh','Kumar','senthilraj@gmail.com',NULL,'4dd72b625bfc25eccef5cbeb83196c1175fedb1f','chennai','044-20008000','1','515ab656-d0c0-471d-b325-13c4cd6442f8'),(41,'smart','entry','senthil@gmail.com',NULL,'17f8a4a06d684e3d5b9282db36e38dc4d04cd3b2','chennai','044-16151526','1','515eb961-0f3c-4bec-87d2-00c40ac7324b'),(42,'Ramesh','Kumar','ramesh@gmail.com',1,'17083aacc8ce9486ad6edd41a1b2a38a702b6762','chennai','044-32460006','1','51652df9-5a14-40be-aeed-03ac0ac7324b');
...
CREATE TABLE `hrpostresumes` (
  ...
  `primaryresume` varchar(3) DEFAULT NULL,
...
insert  into `hrpostresumes`(`id`,`exp_year`,`exp_month`,`joblocation`,`myname`,`companyname`,`category`,`categoryrole`,`rolesel`,`keyskills`,`joblocation_pre`,`jobpresel`,`jobtype`,`ug_qualification`,`pg_qualification`,`resumetitle`,`resume`,`primaryresume`,`employee_id`) values (1,'3','10','Mumbai','Abbas Ali','TCS','5',NULL,'9,10','php, java, CAKE','','Chennai,Mumbai','Freelancing','B.B.A','M.Tech','SUPER RESUME','17025_SenthilKumarCV_india.doc','no',37),(2,'0','5','Mumbai','smart entry','smart entry pvt','3',NULL,'5,6','PHP, mysql, ajax','','Mumbai,Kolkatta','Full Time','B.Tech','','My resume','14688_SathishKrishnanResume.doc','yes',41),(3,'1','5','Mumbai','good one','good one1','4',NULL,'7,8','good one2','','Chennai','Part Time','B.B.A','M.B.A','good one3','9552_SenthilKumarCV_india.doc','no',37),(4,'1','4','Mumbai','good one','good one1','3',NULL,'5','good one2','','Chennai','Part Time','B.B.A','M.C.A','good one3','26862_SenthilKumarCV_india.doc','no',37),(5,'3','3','Mumbai','dsfwer','werwe','1',NULL,'2','werw','','Chennai','Full Time','B.ED','M.ED','werwer','22610_SenthilKumarCV_india.doc','no',37),(6,'3','','','','','',NULL,NULL,'','',NULL,'','','','','26320_SenthilKumarCV_india.doc','no',37),(7,'5','','','','','',NULL,NULL,'','',NULL,'','','','','28243_SenthilKumarCV_india.doc','no',37),(8,'3','3','Kolkatta','dsfwer','werwe','5',NULL,'9','werw','','Chennai,Mumbai','Part Time','B.com','M.ED','werwer','5959_SenthilKumarCV_india.doc','yes',37),(9,'4','0','Chennai','Ramesh','ITSA','5',NULL,'9','Windows Administration','','Chennai','Full Time','B.Sc','M.C.A','System Administration with 5 yrs of Experiance','2804_MANIKANDAN.doc','yes',42);
...
CREATE TABLE `jobposts` (
  ...
  `titlerole` varchar(255) DEFAULT NULL,
  ...
  `ugdegree` varchar(100) DEFAULT NULL,
  `pgdegree` varchar(100) DEFAULT NULL,
  `jobdescrip` text,
  `walkin` varchar(20) DEFAULT NULL,
  ...
  `empuser` varchar(50) DEFAULT NULL,
  `emppass` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `jobposts` */
